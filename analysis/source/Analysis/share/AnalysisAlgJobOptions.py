...
jps.AthenaCommonFlags.FilesInput = ["/afs/cern.ch/work/l/lprincip/private/workingDM/oldAnalysis/inputFile/20200321.DAOD_PASSTHR.10000evts.pool.root"]        #set on command-line with: --filesInput=...
